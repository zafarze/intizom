...
const isFirebaseConfigured = !!firebaseConfig.apiKey && !!VAPID_KEY;

if (!isFirebaseConfigured) {
    console.error("FIREBASE ERROR: Missing VITE_FIREBASE_API_KEY or VITE_FIREBASE_VAPID_KEY in .env file! Push notifications are disabled.");
}
